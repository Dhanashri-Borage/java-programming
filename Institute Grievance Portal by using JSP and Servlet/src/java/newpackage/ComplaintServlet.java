...
public class ComplaintServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //make user object
Complaint comModel = new Complaint(name,department,complainttype,comment,witness,date);

//create a database model
ComplaintDatabase regComplaint = new ComplaintDatabase(ConnectionPro.getConnection());
if (regComplaint.saveComplaint(comModel)){
