<%-- 
    Document   : accounts
    Created on : 20 May, 2020, 8:37:10 PM
    Author     : DELL
--%>
...
<html>
    <head>
        ...
        <title>Account Grievances</title>
...
%>
<h2 align="center"><font><strong> Account Grievances </strong></font></h2>
...
<tr>
   ...
   <%
	try{	
		...
		String sql ="select * from complaint where complainttype='accounts'";
