<%-- 
    Document   : library
    Created on : 20 May, 2020, 8:37:31 PM
    Author     : DELL
--%>
...
<html>
    <head>
        ...
        <title>Library Grievances</title>
...
%>
<h2 align="center"><font><strong> Library Grievances </strong></font></h2>
...
<tr>
   ...
   <%
	try{	
		...
		String sql ="select * from complaint where complainttype='library'";
