<%-- 
    Document   : exam
    Created on : 20 May, 2020, 8:34:36 PM
    Author     : DELL
--%>
<%-- 
    Document   : fetch_all
    Created on : 20 May, 2020, 7:06:14 PM
    Author     : DELL
--%>
...
%>
<h2 align="center"><font><strong> Exam Grievances </strong></font></h2>
...
<tr>
   ...
   <%
	try{	
		...
		String sql ="select * from complaint where complainttype='exam'";
