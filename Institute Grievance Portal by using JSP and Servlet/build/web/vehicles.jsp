<%-- 
    Document   : vehicles
    Created on : 20 May, 2020, 8:38:48 PM
    Author     : DELL
--%>
...
<html>
    <head>
        ...
        <title>Vehicles Grievances</title>
...
%>
<h2 align="center"><font><strong> Vehicle Grievances </strong></font></h2>
...
<tr>
   ...
   <%
	try{	
		...
		String sql ="select * from complaint where complainttype='vehicles'";
...
%>
        ...
        <div>
         ...
         <br><br>  <center><u><b><h2>Grievance Categories</h2></b> </u> <center>
             ...
             <a href="hostel.jsp">Hostel</a>&emsp;&emsp;
             ...
             <a href="administartive.jsp">Administrative</a>&emsp;&emsp;
