<%-- 
    Document   : teachers
    Created on : 20 May, 2020, 8:39:03 PM
    Author     : DELL
--%>
...
<html>
    <head>
        ...
        <title>Teachers Grievances</title>
...
%>
<h2 align="center"><font><strong> Teachers Grievances </strong></font></h2>
...
<tr>
   ...
   <%
	try{	
		...
		String sql ="select * from complaint where complainttype='teachers'";
