<%-- 
    Document   : campus
    Created on : 20 May, 2020, 8:35:48 PM
    Author     : DELL
--%>
...
%>
<h2 align="center"><font><strong> Campus Grievances </strong></font></h2>
...
<tr>
   ...
   <%
	try{	
		...
		String sql ="select * from complaint where complainttype='campus'";
