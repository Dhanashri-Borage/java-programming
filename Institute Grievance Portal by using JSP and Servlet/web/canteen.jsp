<%-- 
    Document   : canteen
    Created on : 20 May, 2020, 8:38:11 PM
    Author     : DELL
--%>
...
<html>
    <head>
        ...
        <title>Canteen Grievances</title>
...
%>
<h2 align="center"><font><strong> Canteen Grievances </strong></font></h2>
...
<tr>
   ...
   <%
	try{	
		...
		String sql ="select * from complaint where complainttype='canteen'";
