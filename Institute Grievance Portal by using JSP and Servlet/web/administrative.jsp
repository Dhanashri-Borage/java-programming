<%-- 
    ...
    Created on : 20 May, 2020, 8:39:25 PM
    Author     : DELL
--%>
...
<html>
    <head>
        ...
        <title>Administrative Grievances</title>
...
%>
<h2 align="center"><font><strong> Administrative Grievances </strong></font></h2>
...
<tr>
   ...
   <%
	try{	
		...
		String sql ="select * from complaint where complainttype='administrative'";
