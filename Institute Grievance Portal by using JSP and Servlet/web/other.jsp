<%-- 
    Document   : other
    Created on : 20 May, 2020, 8:39:47 PM
    Author     : DELL
--%>
...
%>
<h2 align="center"><font><strong> Other Grievances </strong></font></h2>
...
<tr>
   ...
   <%
	try{	
		...
		String sql ="select * from complaint where complainttype='other'";
