<%-- 
    Document   : course
    Created on : 20 May, 2020, 8:34:20 PM
    Author     : DELL
--%>
...
%>
<h2 align="center"><font><strong> Course Grievances </strong></font></h2>
...
<tr>
   ...
   <%
	try{	
		...
		String sql ="select * from complaint where complainttype='course'";
